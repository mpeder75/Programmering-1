...
Console.WriteLine($"\nSummen af index {myIntArray.GetValue(0)}, {myIntArray.GetValue(2)}, {myIntArray.GetValue(4)}, {myIntArray.GetValue(7)} er : {sum}");
Console.WriteLine($"\nSummen af int værdier i array : {myIntArray.Sum()}");